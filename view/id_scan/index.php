...
<head>
    <script nomodule="" defer="" src="../scanner/js/index.runtime.0ba3fbea.js"></script>
    <script type="module" src="../scanner/js/index.runtime.7930a9c0.js"></script>
    <meta charset="utf-8">
    ...
    <link rel="apple-touch-icon" href="../scanner/images/apple-touch-icon.cbfc4d72.png">
    <link rel="manifest" href="manifest.webmanifest">
    <meta name="theme-color" content="#212529">
    <meta name="color-scheme" content="light dark">
    <link rel="stylesheet" href="../scanner/css/index.83054abb.css">
    <link rel="stylesheet" href="../scanner/css/index.96d2ebb1.css">
</head>
...
<body> <noscript>
    ...
    <div class="container"> <a-tab-group no-scroll-controls="" no-tab-cycling=""> <a-tab slot="tab" role="heading"
                id="cameraTab"  style="display:none"> <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor"
                ...
                <center><button onclick="location.href='../list/'" style="transform:scale(0.8)">View Attendance</button></center>  
            </a-tab-panel> <a-tab slot="tab" role="heading" id="fileTab" style="display:none"> <svg width="18" height="18"
    ...
    <script>
        function pasteAndDisplay(scanResult) {
               var text = document.getElementById(scanResult).innerText;
                location.href="../booklet_scan/?exam=<?php echo $id ?>&id="+text;
        }
        </script>
    <script src="../scanner/js/index.bb1ce697.js" type="module"></script>
    <script src="../scanner/js/index.98a7b582.js" nomodule="" defer=""></script>
    <script src="../scanner/js/index.ad39ef8d.js" type="module"></script>
    <script src="../scanner/js/index.7cafa558.js" nomodule="" defer=""></script>
